...
def aggregate():
  ...
  for profile in profiles:
    subprocess.call('nmcli connection down {}'.format(profile.replace('.nmconnection', '')),shell=True)
    subprocess.call('nmcli connection modify {} autoconnect no'.format(profile.replace('.nmconnection', '')),shell=True)
